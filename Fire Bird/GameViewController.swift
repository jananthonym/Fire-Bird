...
//  FireBird
//
//  Created by Jan Anthony Miranda on 6/21/15.
...
class GameViewController: UIViewController, ADInterstitialAdDelegate, SKProductsRequestDelegate, SKPaymentTransactionObserver {
    ...
    override func viewDidLoad() {
        ...
        if !showedAd && !showedGAd {
            ...
            if(SKPaymentQueue.canMakePayments()) {
                ...
                let productID:NSSet = NSSet(objects: "fbNoAds")
    ...
    func interstitialAdActionDidFinish(_interstitialAd: ADInterstitialAd!){
        if placeHolderView != nil {
            ...
            closeButton.removeFromSuperview()
            cycleInterstitial()
            print("called just before dismissing - action finished")
        }
    ...
    func createAndLoadAd() -> GADInterstitial {
        ...
        let ad = GADInterstitial(adUnitID: "ca-app-pub-4409172322766542/3642016915")
